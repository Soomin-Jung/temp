...
> 각 proposer가 **왜** serial/parallel/multi-head/block 구조를 사용하는지와 실제 선택 기준은 [vLLM SD Method Taxonomy & Selection Guide](01-vllm-method-taxonomy-and-selection.md)를 먼저 참고한다.
